            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                    ...
                    <motion.h1
                        ...
                        className="text-4xl md:text-8xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-white/50 mb-4 py-2 leading-tight break-keep font-display"
                    >
                        {t("title")}
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        className="text-base md:text-lg text-gray-400 text-md mb-12 leading-relaxed whitespace-pre-line max-w-2xl mx-auto"
                    >
                        {t("subtitle")}
                    </motion.p>
                    ...
                    >
                        <a href="https://tally.so/r/68d2Gk" target="_blank" rel="noopener noreferrer">
                            ...
                            >
                                <MessageSquare className="mr-2 w-5 h-5" /> {t("cta")}
                            </Button>
                        </a>
                    </motion.div>
