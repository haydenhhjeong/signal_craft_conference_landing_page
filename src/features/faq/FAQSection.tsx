...
export function FAQSection() {
    ...
    return (
        <section id="faq" className="py-16 bg-[#050505] relative overflow-hidden">
            {/* Background VFX */}
            ...
            <div className="container mx-auto px-4 max-w-6xl relative z-10">
                <div className="text-center mb-20">
                    ...
                    >
                        ...
                        <h2 className="text-3xl md:text-5xl font-bold leading-tight text-white break-keep font-display">
                            {t("title")}
                        </h2>
                    </motion.div>
                </div>

                <div className="flex flex-col gap-4 max-w-4xl mx-auto items-stretch">
                    {questions.map((key, index) => (
                        ...
                        >
                            ...
                            >
                                <div className=" pb-8 text-gray-400 text-lg leading-relaxed break-keep border-t border-white/5 pt-6 mx-8">
                                    {t(`questions.${key}.a`)}
                                </div>
                            </motion.div>
                        </motion.div>
