        ...
        <div className="pt-16 md:pt-24 pb-16 md:pb-24 bg-background">
            <section className="container mx-auto px-4 mb-12 md:mb-16">
                ...
                <motion.p
                    ...
                    className="text-base md:text-lg text-gray-400 text-center max-w-2xl mx-auto mb-8 md:mb-12 break-keep"
                >
                    {t("description_page")}
                </motion.p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
                    {allNews.map((item, i) => (
                        ...
                        >
                            ...
                            <p className="text-base md:text-lg text-gray-400 mb-6 line-clamp-2 break-keep leading-relaxed flex-1">
