        ...
        <div className="min-h-screen bg-[#050505] text-white pt-32 pb-24">
            ...
            <section className="container mx-auto px-4 mb-24">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <h1 className="text-3xl md:text-6xl font-black mb-8 tracking-tighter font-display italic uppercase">
                            {t("title")}
                        </h1>
                        <p className="text-base md:text-lg text-gray-400 leading-relaxed break-keep font-medium">
                            {t("subtitle")}
                        </p>
                    </motion.div>
                </div>
                            ...
                            <ul className="space-y-6">
                                {[1, 2, 3].map((num) => (
                                    <li key={num} className="flex gap-4 group">
                                        ...
                                        <p className="text-base md:text-lg text-gray-400 group-hover:text-white transition-colors">
                                            {t(`hardware.step${num}`)}
                                        </p>
                                    </li>
                                ))}
                ...
                <div className="max-w-6xl mx-auto bg-white/5 border border-white/10 rounded-[2.5rem] p-8 md:p-16 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="aspect-[9/16] rounded-3xl bg-white/5 border border-white/10 flex flex-col items-center justify-center p-6 text-center">
                                    ...
                                    <p className="text-base md:text-lg text-gray-400 font-bold">{t("app.features.monitoring")}</p>
                                </div>
                                <div className="aspect-[9/16] rounded-3xl bg-white/5 border border-white/10 flex flex-col items-center justify-center p-6 text-center mt-8">
                                    ...
                                    <p className="text-base md:text-lg text-gray-400 font-bold">{t("app.features.notifications")}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-base md:text-lg text-gray-400 mb-10 leading-relaxed break-keep">
                                {t("app.description")}
                            </p>
            ...
            <section className="mt-32 border-t border-white/10 py-24 text-center">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-base md:text-lg text-gray-400 mb-12">{t("support.description")}</p>
