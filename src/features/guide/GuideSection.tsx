...
export function GuideSection() {
    ...
    return (
        <section id="guide" className="py-8 bg-[#050505] relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-3xl md:text-5xl font-bold leading-tight text-white break-keep font-display mb-6">
                            {t("title")}
                        </h2>
                    ...
                    {steps.map((step, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-base md:text-lg text-gray-400 leading-relaxed break-keep max-w-[280px] mx-auto">
