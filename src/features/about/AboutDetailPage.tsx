        ...
        <div ref={containerRef} className="bg-[#050505] text-white selection:bg-blue-500/30">
                                    ...
                                    <div className="flex-1 text-center md:text-right">
                                        {i % 2 === 0 ? (
                                            <>
                                                ...
                                                <p className="text-base md:text-lg text-gray-400">{t(`journey.milestones.${year}.desc`)}</p>
                                            </>
                                        ) : null}
                                    </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center mb-20">
                        ...
                        <motion.p
                            ...
                            className="text-base md:text-lg text-gray-400 font-bold tracking-tight mb-6"
                        >
                            {t("global.subtitle")}
                        </motion.p>
                        <motion.p
                        ...
                        <div className="absolute inset-0 z-10">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-6 w-56 opacity-0 group-hover/node:opacity-100 transition-all pointer-events-none transform translate-y-2 group-hover/node:translate-y-0 text-left">
                                        <div className="bg-black/90 backdrop-blur-2xl p-5 rounded-2xl border border-white/20 shadow-2xl">
                                            <p className="text-base md:text-lg text-gray-400 text-blue-500 font-black uppercase tracking-widest mb-2">Seoul Hub</p>
                                            <p className="text-base md:text-lg text-gray-400 font-bold">Innovation Center</p>
                                            <p className="text-base md:text-lg text-gray-400 mt-1 mb-3">Data Intelligence & Global Bridge</p>
                            ...
                            <div className="absolute top-[25%] left-[36%] group/node">
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-6 w-52 opacity-0 group-hover/node:opacity-100 transition-all pointer-events-none transform translate-y-2 group-hover/node:translate-y-0 text-left">
                                        <div className="bg-black/90 backdrop-blur-2xl p-5 rounded-2xl border border-white/20 shadow-2xl">
                                            <p className="text-base md:text-lg text-gray-400 text-orange-500 font-black uppercase tracking-widest mb-2">Yongin Hub</p>
                                            <p className="text-base md:text-lg text-gray-400 font-bold">infinior HQ</p>
                                            <p className="text-base md:text-lg text-gray-400 mt-1 mb-3">AI Solution & Embedded Tech (Giheung)</p>
                                            <div className="flex flex-wrap gap-1.5">
                            ...
                            <div className="absolute top-[65%] left-[30%] group/node">
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-6 w-52 opacity-0 group-hover/node:opacity-100 transition-all pointer-events-none transform translate-y-2 group-hover/node:translate-y-0 text-left">
                                        <div className="bg-black/90 backdrop-blur-2xl p-5 rounded-2xl border border-white/20 shadow-2xl">
                                            <p className="text-base md:text-lg text-gray-400 text-emerald-500 font-black uppercase tracking-widest mb-2">Jeonnam Hub</p>
                                            <p className="text-base md:text-lg text-gray-400 font-bold">Bio & Chemical</p>
                                            <p className="text-base md:text-lg text-gray-400 mt-1 mb-3">Process Monitoring & Safety</p>
                                            <div className="flex flex-wrap gap-1.5">
                            ...
                            <div className="absolute top-[60%] left-[76%] group/node">
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-6 w-52 opacity-0 group-hover/node:opacity-100 transition-all pointer-events-none transform translate-y-2 group-hover/node:translate-y-0 text-left">
                                        <div className="bg-black/90 backdrop-blur-2xl p-5 rounded-2xl border border-white/20 shadow-2xl">
                                            <p className="text-base md:text-lg text-gray-400 text-purple-500 font-black uppercase tracking-widest mb-2">Busan Hub</p>
                                            <p className="text-base md:text-lg text-gray-400 font-bold">Heavy Industry</p>
                                            <p className="text-base md:text-lg text-gray-400 mt-1 mb-3">Maritime & Industrial Infra</p>
                                            <div className="flex flex-wrap gap-1.5">
            ...
            <section className="py-32 container mx-auto px-4">
                <div className="text-center mb-24">
                    ...
                    <p className="text-base md:text-lg text-gray-400">Pioneering the future of acoustic intelligence.</p>
                </div>
                    ...
                    {TEAM_KEYS.map((key, i) => (
                        ...
                        >
                            ...
                            <div className="mt-8">
                                ...
                                <p className="text-base md:text-lg text-gray-400 text-blue-500 font-bold mb-4">{t(`team.members.${key}.role`)}</p>
                                <p className="text-base md:text-lg text-gray-400 mb-8 font-light leading-relaxed">{t(`team.members.${key}.bio`)}</p>
            ...
            <section className="py-32 container mx-auto px-4 text-center border-t border-white/10">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl mx-auto mb-12">From Seoul to San Francisco, SignalCraft is the voice of industrial reliability.</p>
            </section>
        </div>
    );
}
