    ...
    return (
        <div className="pt-16 md:pt-24 pb-16 md:pb-24">
            <section className="container mx-auto px-4 mb-12 md:mb-20 text-center">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-2xl mx-auto break-keep">
                    {t("description")}
                </p>
            </section>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-base md:text-lg text-gray-400 whitespace-pre-line">{t("info.address.value")}</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-lg text-blue-600">
                                ...
                                <div>
                                    ...
                                    <p className="text-base md:text-lg text-gray-400">{t("info.email.value")}</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-lg text-blue-600">
                                ...
                                <div>
                                    ...
                                    <p className="text-base md:text-lg text-gray-400">{t("info.phone.value")}</p>
                                    <p className="text-base md:text-lg text-gray-400 mt-1">{t("info.phone.sub")}</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-lg text-blue-600">
                                ...
                                <div>
                                    ...
                                    <p className="text-base md:text-lg text-gray-400">{t("info.ceo.value")}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-muted/50 p-8 rounded-2xl border border-border">
                        ...
                        <div className="space-y-4">
                            <details className="group">
                                ...
                                <p className="text-base md:text-lg text-gray-400 mt-2 pl-4 border-l-2 border-blue-500">
                                    {t("faq.q1.a")}
                                </p>
                            </details>
                            <details className="group">
